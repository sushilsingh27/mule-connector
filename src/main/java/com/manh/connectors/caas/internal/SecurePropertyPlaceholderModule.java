...
import static com.manh.connectors.caas.internal.security.encryption.binary.jce.algorithms.EncryptionAlgorithm.Blowfish;
import static com.manh.connectors.caas.internal.security.encryption.binary.jce.algorithms.EncryptionMode.CBC;
...
public class SecurePropertyPlaceholderModule {
    ...
    public byte[] decrypt(byte[] payload) throws MuleEncryptionException {
        try {
            ...
            throw new RuntimeException("Could not decrypt the data or " + e.getMessage(), e.getCause());
